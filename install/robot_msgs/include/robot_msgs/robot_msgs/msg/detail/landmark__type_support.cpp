...
{
  new (message_memory) robot_msgs::msg::Landmark(_init);
}

void Landmark_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_msgs::msg::Landmark *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Landmark_message_member_array[3] = {
  {
    ...
    offsetof(robot_msgs::msg::Landmark, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_msgs::msg::Landmark, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_msgs::msg::Landmark, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Landmark_message_members = {
  ...
  3,  // number of fields
  sizeof(robot_msgs::msg::Landmark),
...
get_message_type_support_handle<robot_msgs::msg::Landmark>()
{
  return &::robot_msgs::msg::rosidl_typesupport_introspection_cpp::Landmark_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msgs, msg, Landmark)() {
  return &::robot_msgs::msg::rosidl_typesupport_introspection_cpp::Landmark_message_type_support_handle;
}
